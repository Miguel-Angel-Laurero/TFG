        ...
        <main class="flex-1 min-h-0 overflow-y-auto">
            <div class="w-full min-h-full p-4">
                ...
                <div v-if="duel.duelStatus === 'idle'"
                    ...
                    <p class="text-slate-400 text-sm">Conectando al duelo…</p>
                </div>

                <!-- Duelo cancelado o error -->
                <div v-else-if="duel.duelStatus === 'cancelled'"
                    ...
                    <h2 class="text-white font-bold text-xl">Duelo cancelado</h2>
                    <!-- H9: mensaje de error legible -->
                    <p class="text-slate-400 text-sm">{{ duel.error ?? 'El duelo fue cancelado.' }}</p>
