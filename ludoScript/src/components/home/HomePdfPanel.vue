<template>
  <section class="flex flex-col gap-5 h-full">
    ...
    <div class="flex items-center justify-between flex-shrink-0">
      <h3 class="text-lg font-semibold text-gray-50 font-righteous">
        Documentos
      </h3>
    ...
    <div
      v-if="uploadError"
      class="flex-shrink-0 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2"
    >
      <p class="text-xs text-red-300">
        {{ uploadError }}
      </p>
      <button
        v-if="showTutorialFallbackCta"
        data-testid="tutorial-local-cta"
    ...
    >
      <div class="flex items-center justify-between gap-3">
        <div class="min-w-0">
          ...
          <p class="text-[11px] text-indigo-100/75 mt-0.5">
      ...
      >
        ...
        <div class="min-w-0 flex-1">
          <p class="text-gray-100 font-medium text-sm">
            Tutorial local de programacion
          </p>
          <p class="text-gray-400 text-xs mt-0.5">
            Fundamentos JS, arrays, funciones, objetos y asincronia
          </p>
        </div>
        <span
    ...
    <div class="flex flex-col gap-2 flex-1 min-h-0">
      ...
      >
        ...
        >
          ...
          <svg
            v-else-if="someUploadedSelected"
            class="w-2.5 h-2.5 text-white"
            fill="none"
            viewBox="0 0 10 10"
          >
      ...
      <div
        v-if="loading"
        class="flex justify-center py-4 ml-6"
      >
      ...
      <ul
        v-else
        class="flex flex-col gap-2 overflow-y-auto flex-1 ml-6"
      >
        <li
          v-for="pdf in pdfs"
          :key="pdf.id"
        ...
        >
          ...
          >
            <svg
              v-if="selectedFiles.includes(pdf.id)"
              class="w-2.5 h-2.5 text-white"
              fill="none"
              viewBox="0 0 10 10"
            >
          ...
          <div class="min-w-0 flex-1">
            <p
              class="text-gray-100 font-medium text-sm truncate"
          ...
          >
            ...
            <svg
              v-if="pdfLocalStatus[pdf.id]?.saving"
          ...
          <span
            ...
            class="flex-shrink-0 text-emerald-400 p-1 leading-none"
