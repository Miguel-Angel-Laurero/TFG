    ...
    >
      ...
      <div class="min-w-0">
        <div class="flex items-center gap-2 flex-wrap">
          ...
          <span
            :class="memberCountColor"
            class="text-xs font-semibold px-2 py-0.5 rounded-full bg-white/10"
          >
        ...
        <p
          ...
          class="text-sm text-slate-400 mt-1 truncate"
        >
          {{ group.description }}
        </p>
      </div>
      ...
      <div class="flex flex-col sm:items-end gap-2 flex-shrink-0">
        ...
        >
          ...
          <span
            v-else
            class="text-slate-400 group-hover:text-white transition-colors text-sm"
          >📋</span>
        </button>
