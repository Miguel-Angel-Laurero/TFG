  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[calc(100vh-80px)] w-full max-w-7xl mx-auto gap-4 lg:gap-12">
    ...
    <div class="order-1 lg:order-2 flex flex-col gap-6 w-full max-w-lg mx-auto py-6 px-4 md:px-6">
      <div class="text-center lg:text-left">
        <h2 class="text-2xl md:text-3xl font-bold text-white font-righteous">
          Únete a una Clase
        </h2>
        <p class="text-slate-400 text-sm md:text-base mt-2">
          Aprende y compite con otros jugadores en tu clase
        </p>
      </div>
      ...
      >
        ...
        <div class="flex flex-col gap-2">
          ...
          <p
            v-if="joinError"
            class="text-red-400 text-xs italic ml-1"
          >
            {{ joinError }}
          </p>
        </div>
