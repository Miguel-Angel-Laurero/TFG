  ...
  >
    ...
    <div class="flex-shrink-0 w-8 text-center">
      <span
        v-if="rank === 1"
        class="text-xl"
      ><img :src="IMAGES.medalla_1"></span>
      <span
        v-else-if="rank === 2"
        class="text-xl"
      ><img :src="IMAGES.medalla_2"></span>
      <span
        v-else-if="rank === 3"
        class="text-xl"
      ><img :src="IMAGES.medalla_3"></span>
      <span
        v-else
    ...
    <div class="flex-1 min-w-0">
      <div class="flex items-center gap-2 flex-wrap">
        ...
        <span
          v-if="isCurrentUser"
          class="text-[10px] bg-indigo-600/60 text-indigo-200 px-1.5 py-0.5 rounded-full"
        >Tú</span>
        <span
          v-if="isOwner"
          class="text-[10px] bg-yellow-500/20 flex text-yellow-300 px-1.5 py-0.5 rounded-full"
        ><img
          :src="IMAGES.corona"
          class="w-8"
        >
    ...
    >
      <button
        title="Transferir liderazgo a este miembro"
        ...
        @click="$emit('transfer', member.userId)"
      >
        <img
          :src="IMAGES.corona"
          class="w-8"
