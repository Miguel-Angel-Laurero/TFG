  ...
  >
    <div class="bg-slate-800 border border-white/10 rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-4">
      ...
      <p class="text-slate-400 text-sm">
        Selecciona el miembro que asumirá el liderazgo de la clase. Tú pasarás a
        ser un miembro normal.
      </p>
      ...
      <div class="flex flex-col gap-2 max-h-60 overflow-y-auto">
        ...
        >
          ...
          <div
            v-else
            class="w-8 h-8 rounded-full bg-slate-600 flex items-center justify-center text-sm"
          >
            👤
          </div>
