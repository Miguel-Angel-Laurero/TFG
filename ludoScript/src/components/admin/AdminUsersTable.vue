    ...
    <div>
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    @click="$emit('create')"
                    class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white text-sm rounded font-medium shadow transition"
                >
        ...
        <!-- Error alert -->
        <div v-if="error" class="bg-red-500/20 text-red-300 p-3 rounded mb-4 flex justify-between">
            <span>{{ error }}</span>
