  ...
  >
    <div class="bg-gray-800 rounded-lg p-6 w-full max-w-md shadow-xl border border-gray-700">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <img
            v-if="previews.img"
            :src="previews.img"
            class="mt-2 h-16 object-contain rounded"
          >
        </div>
        ...
        <div>
          ...
          >
          <img
            v-if="previews.equipped_img"
            :src="previews.equipped_img"
            class="mt-2 h-16 object-contain rounded"
          >
        </div>
      </div>
      ...
      <div class="mt-6 flex justify-end space-x-3">
        <button
          class="px-4 py-2 cursor-pointer text-gray-400 hover:text-white transition"
          @click="handleClose"
        >
          Cancelar
        </button>
