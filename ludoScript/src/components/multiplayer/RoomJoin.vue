<template>
    <div class="flex flex-col items-center gap-6 w-full max-w-md mx-auto p-6">
        <h2 class="text-white text-2xl font-bold">Unirse a sala</h2>
        <p class="text-white/60 text-sm text-center">
            Introduce el código de 6 caracteres que te ha dado el host.
        </p>

        <input v-model="code" type="text" maxlength="6" placeholder="Ej. A3K7ZP" @keyup.enter="handleJoin"
        ...
        <button @click="handleJoin" :disabled="code.length < 6 || loading"
