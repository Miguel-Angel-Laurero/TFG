<template>
    ...
    <transition name="slide-down">
        <div v-if="group.pendingGroupInvite"
            ...
            <div class="bg-gray-800 border border-green-500/40 rounded-2xl shadow-2xl p-5 pointer-events-auto">
                <div class="flex items-start gap-3">
                    ...
                    <i class="pi pi-users text-green-400 text-xl mt-0.5 shrink-0"></i>

                    <div class="flex-1 min-w-0">
                        <p class="text-white font-bold text-sm leading-tight">¡Partida de Clase!</p>
                        ...
                        <div class="flex gap-2 mt-3">
                            <button @click="handleAccept"
                                ...
                                <i class="pi pi-check mr-1"></i>Aceptar
                            </button>
