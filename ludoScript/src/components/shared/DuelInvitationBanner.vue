<template>
    ...
    <transition name="slide-down">
        <div v-if="duel.pendingInvitation"
            ...
            <div class="bg-gray-800 border border-yellow-500/40 rounded-2xl shadow-2xl p-5 pointer-events-auto">
                <div class="flex items-start gap-3">
                    ...
                    <i class="pi pi-bolt text-yellow-400 text-xl mt-0.5 shrink-0"></i>

                    <div class="flex-1 min-w-0">
                        <p class="text-white font-bold text-sm leading-tight">¡Duelo 1v1!</p>
