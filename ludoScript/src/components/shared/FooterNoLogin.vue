<template>
    <div class="w-full bg-indigo-900 text-gray-50/50 bottom-0 h-20  align-middle px-6 ">
        ...
        <div class="w-full flex border-t-1 mt-2 justify-between">
            <p class="flex items-center ">&copy; 2026 LudoScript - Todos los derechos reservados </p>
            <div class="py-2">
