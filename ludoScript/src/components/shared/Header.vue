<template>
    <div class="w-full bg-blue-900 top-0 py-2 flex items-center justify-between font-righteous ">
        <div class="flex ">
            <Avatar
                ...
                class="mx-4" size="medium" shape="circle" />
            <div class="font-bold text-2xl tracking-tight text-gray-50 flex items-left gap-2">
                <h1>LudoScript /
                    <RouterLink to="/" class="text-white/50 hover:text-yellow-400 transition-colors font-normal">Home
                    </RouterLink>
                </h1>
            </div>
        </div>
