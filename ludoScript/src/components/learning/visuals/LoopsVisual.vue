  ...
  <div class="space-y-5">
    ...
    <div class="bg-gray-900/60 rounded-2xl p-5 flex flex-col items-center gap-4">
      ...
      <div class="w-full bg-gray-700/50 rounded-full h-2.5">
        <div
          class="bg-purple-500 h-2.5 rounded-full transition-all duration-300 ease-out"
      ...
      <div class="text-center">
        ...
        <p
          class="text-7xl font-bold font-mono tabular-nums text-purple-400 transition-all duration-200"
        ...
        <p
          v-if="current >= total"
          class="text-sm text-purple-300 mt-1"
        >
          Bucle completado
        </p>
      </div>
