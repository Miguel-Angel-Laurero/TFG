<template>
  <div class="space-y-4">
    <p class="text-xs text-gray-400">
      Pulsa en cada tipo para ver cómo funciona
    </p>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
      <button
        ...
        @click="selectedType = selectedType?.name === type.name ? null : type"
      >
    ...
    <Transition name="expand">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <p :class="['font-mono font-bold text-sm', selectedType.activeText]">
              {{ selectedType.name }}
            </p>
        ...
        <div class="rounded-lg overflow-hidden border border-white/10">
          ...
          ><code
v-for="(line, i) in selectedType.codeLines"
                 :key="i"
class="block"
>
