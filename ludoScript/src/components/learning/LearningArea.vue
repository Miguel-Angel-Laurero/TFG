<template>
    <div class="min-h-full bg-blue-950/20">
        ...
        <Transition name="slide-left">
            <div v-if="isMobileMenuOpen" class="fixed inset-0 z-50 flex lg:hidden bg-gray-900 flex-col">
                <div class="p-4 border-b border-white/10 flex items-center justify-between bg-gray-800/50">
                    ...
                    <button @click="isMobileMenuOpen = false" class="text-gray-400 hover:text-white p-2">
                        <i class="pi pi-times text-xl"></i>
                    </button>
                </div>
                <div class="p-3 overflow-y-auto flex-1">
                    <ConceptsSidebar :concepts="CONCEPTS" :selected-id="selectedId"
