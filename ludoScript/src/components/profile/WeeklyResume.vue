<template>
    <div class="bg-white/5 rounded-2xl p-5 border border-white/10">
        ...
        <p class="text-white/50 text-xs mb-4">
            Progreso acumulado de las últimas 7 sesiones de Quiz.
        </p>
        ...
        <!-- Cuadrícula de anillos -->
        <div v-else class="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <button v-for="cat in weeklyCategories" :key="cat.key" class="flex flex-col items-center gap-1.5 p-3 rounded-xl
