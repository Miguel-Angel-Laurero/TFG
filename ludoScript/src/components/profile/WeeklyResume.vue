<template>
  <div class="bg-white/5 rounded-2xl p-5 border border-white/10">
    ...
    <div
      v-if="hasWeekly"
      class="mt-4 flex flex-wrap gap-3 text-xs text-white/50"
    >
      <span class="flex items-center gap-1.5">
        <span class="w-3 h-3 rounded-full bg-emerald-500 inline-block" />71-100 %
      </span>
      <span class="flex items-center gap-1.5">
        <span class="w-3 h-3 rounded-full bg-orange-500 inline-block" />41-70 %
      </span>
      <span class="flex items-center gap-1.5">
        <span class="w-3 h-3 rounded-full bg-red-500 inline-block" />0-40 %
      </span>
      <span class="flex items-center gap-1.5">
