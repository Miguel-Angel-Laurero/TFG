<template>
  <transition name="slide-up">
    <div
      v-if="open && slotId"
      class="w-full h-1/2 z-50 absolute bg-slate-700/80 rounded-xl p-3 border border-white/10 flex-shrink-0"
    >
