<template>
  <div class="w-full">
        ...
        <div class="flex flex-col gap-2">
          ...
          >
            ...
            <div class="w-full bg-white/10 rounded-full h-2">
              <div
                class="bg-indigo-400 h-2 rounded-full transition-all duration-500"
    ...
    <template v-else>
      ...
      <div
        v-if="adaptiveWeakCategories.length"
        class="flex flex-wrap gap-2 justify-center mb-4 px-4"
      >
        <span class="text-xs text-slate-400 self-center">Practicando:</span>
        <span
          v-for="cat in adaptiveWeakCategories"
          :key="cat.category"
      ...
      <div
        v-if="loadError"
        class="flex flex-col items-center gap-4 p-10 text-center"
      >
        <p class="text-slate-400 text-sm">
          No se pudieron cargar las preguntas del PDF.
        </p>
        <button
