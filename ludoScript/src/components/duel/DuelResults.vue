<template>
  <div class="flex flex-col items-center gap-6 w-full max-w-xl mx-auto p-6">
    <div class="text-center">
      <p class="text-yellow-400 text-xs font-bold uppercase tracking-widest mb-1">
        ⚔️ Duelo 1v1
      </p>
    ...
    <div class="w-full bg-white/5 rounded-2xl overflow-hidden">
      <table class="w-full">
        ...
        <tbody>
          <tr
            v-for="(player, i) in duel.finalRanking"
            :key="player.userId"
